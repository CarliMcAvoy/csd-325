...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        todo1 = tk.Label(self.tasks_frame, text="--- Add Items Here --- *Right Click Item to Delete*", bg="goldenrod2", fg="black", pady=10)
        ...
        self.color_schemes = [{"bg":"goldenrod1", "fg": "black"},{"bg":"lightblue", "fg":"black"}]
